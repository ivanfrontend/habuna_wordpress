...
<div id="about" class="global"></div>
            ...
            <div class="row">
                ...
                <div class="tab-content testiTabContent">
                    <div role="tabpanel" class="tab-pane active" id="testi1">
                        ...
                        <p>“ Спасибо мастеру за оперативную помощь в ремонте ноутбука. Быстро произвел диагностику, установил поломку компьютера, помог в покупке неисправной детали. ”</p>
                    </div>
                    <div role="tabpanel" class="tab-pane" id="testi2">
                        <h5 class="customerName">Светлана Простова</h5>
                        <h5 class="customerType">менеджер</h5>
                        <p>“ Мне необходим был ремонт ноутбука, установка необходимых программ. Мастер хороший, все сделал, проблем по работе не было, мастеру оценка отлично! ”</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
      function initMap() {
        var uluru = {lat: 53.88273453, lng: 27.58976331};
